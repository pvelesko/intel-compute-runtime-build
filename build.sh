...
cmake ${BUILD_TOOL} --build gmmlib/build --config Release
...
cmake ${BUILD_TOOL} --build igsc/build --config Release
...
cmake ${BUILD_TOOL} --build igc/build --config Release
...
cmake ${BUILD_TOOL} --build neo/build --config Release
